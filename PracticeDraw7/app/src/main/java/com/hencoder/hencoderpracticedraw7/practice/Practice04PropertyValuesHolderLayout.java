    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder mPropertyValuesHolder1 = PropertyValuesHolder.ofFloat("scaleX", 0, 1);
                PropertyValuesHolder mPropertyValuesHolder2 = PropertyValuesHolder.ofFloat("scaleY", 0, 1);
                PropertyValuesHolder mPropertyValuesHolder3 = PropertyValuesHolder.ofFloat("alpha", 0, 1);

                // 然后，用 ObjectAnimator.ofPropertyValuesHolder() 把三个属性合并，创建 Animator 然后执行

                ObjectAnimator mObjectAnimator = ObjectAnimator.ofPropertyValuesHolder(view, mPropertyValuesHolder1,
                        mPropertyValuesHolder2, mPropertyValuesHolder3);
