    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe mKeyframe1 = Keyframe.ofFloat(0, 0);
                Keyframe mKeyframe2 = Keyframe.ofFloat(0.5f, 100);
                Keyframe mKeyframe3 = Keyframe.ofFloat(1, 80);

                PropertyValuesHolder mPropertyValuesHolder=PropertyValuesHolder
                        .ofKeyframe("progress", mKeyframe1,mKeyframe2,mKeyframe3);
                ObjectAnimator mObjectAnimator = ObjectAnimator
                        .ofPropertyValuesHolder(view, mPropertyValuesHolder);
